<x-app-layout>
    <header class="masthead" style="background-image: url({{ asset('assets/img/header-bg.jpg') }})">
        <div class="container">
            <div class="masthead-subheading">Welcome To Lab. K3</div>
            <div class="masthead-heading text-uppercase">It's Nice To Meet You</div>
            <a class="btn btn-primary btn-xl text-uppercase" href="#">Registration</a>
        </div>
    </header>
    <!-- Services-->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto text-center"><p class="large text-muted">Lorem ipsum dolor sit amet,
                        consectetur adipisicing elit. Aut eaque, laboriosam veritatis, quos non quis ad perspiciatis,
                        totam
